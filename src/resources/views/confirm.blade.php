        ...
        <div class="confirm-table">
          <table class="confirm-table__inner">
            ...
            <tr class="confirm-table__row">
              ...
              <td class="confirm-table__text">
                <input type="text" name="tel" value="{{ $contact['areaNumber'] }}" readonly>
                <input type="text" name="tel" value="{{ $contact['localNumber'] }}" readonly>
                <input type="text" name="tel" value="{{ $contact['subscNumber'] }}" readonly>
              </td>
            </tr>
            <tr class="confirm-table__row">
